...
/// </summary>
public class HexalithAzureContainerAppAuthenticationClientModule : IClientApplicationModule
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public string Id => "Hexalith.AzureContainerAppAuthentication.Client";
